...
class WeatherCenterScreen extends StatelessWidget {
  ...
  Future<void> _speak(BuildContext context, WeatherSnapshot snapshot) async {
    final scope = AppScope.of(context);
      ...
      children: [
          ...
          children: [
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(labelText: context.tr('latitude')),
              ),
            ),
            const SizedBox(width: 10),
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(labelText: context.tr('longitude')),
              ),
            ),
          ],
        ),
        ...
        SizedBox(
          ...
          child: FilledButton.icon(
            ...
            label: Text(
              context.tr(saving ? 'loading_weather' : 'save_weather_location'),
            ),
          ),
        ),
      ],
    ...
    child: Padding(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 14),
          Text(context.tr(loading ? 'loading_weather' : 'weather_unavailable')),
          if (!loading) ...[
...
class _WeatherHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Row(
      children: [
        Icon(_weatherIcon(snapshot.weatherCode), color: Colors.white, size: 58),
