    ...
    return Scaffold(
      ...
      body: SafeArea(top: false, child: Center(child: ConstrainedBox(constraints: const BoxConstraints(maxWidth: 720),
        child: Column(children: [
          Expanded(child: ListView(controller: scroll, padding: const EdgeInsets.fromLTRB(20, 16, 20, 12), children: [
            ...
            Wrap(spacing: 8, runSpacing: 8, children: [
              for (final choice in [(IlaiTopic.summary, t('What is wrong?', 'என்ன பிரச்சினை?')),
                ...
                ActionChip(label: Text(choice.$2), onPressed: () => _ask(choice.$2, choice.$1)),
            ]),
          ])),
