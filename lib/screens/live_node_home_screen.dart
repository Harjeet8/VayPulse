...
class _ConnectionStripState extends State<_ConnectionStrip> {
  ...
  Widget build(BuildContext context) {
    ...
    if (!widget.live) {
      ...
      title = _competitionText(
          context, 'Searching for PhytoSense node…', 'சாதனம் தேடப்படுகிறது…');
    } else if (stale) {
      title = _competitionText(
      ...
      title = switch (_connectionStage) {
        1 =>
          _competitionText(context, 'Node detected', 'சாதனம் கண்டறியப்பட்டது'),
        2 => _competitionText(
          ...
          Wrap(
            ...
            children: [
              ...
              OutlinedButton.icon(
                ...
                label: Text(_competitionText(
                    context, 'Connect my sensor', 'சாதனத்தை இணை')),
              ),
            ],
          ),
        ],
