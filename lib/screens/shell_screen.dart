    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        final pages = [
          ...
          live ? const LiveSensorsScreen() : const PlantsScreen(),
        ...
        return CallbackShortcuts(
          bindings: {
            const SingleActivator(LogicalKeyboardKey.digit1, alt: true): () => setState(() => index = 0),
            const SingleActivator(LogicalKeyboardKey.digit2, alt: true): () => setState(() => index = 1),
            const SingleActivator(LogicalKeyboardKey.digit3, alt: true): () => setState(() => index = 2),
            const SingleActivator(LogicalKeyboardKey.digit4, alt: true): () => setState(() => index = 3),
            const SingleActivator(LogicalKeyboardKey.digit5, alt: true): () => setState(() => index = 4),
            const SingleActivator(LogicalKeyboardKey.keyK, control: true): () => showSearch<void>(
                  context: context,
                  delegate: AppCommandSearch(searchLabel: context.tr('command_search_hint')),
                ),
          },
          child: Focus(
            autofocus: true,
                            ...
                            child: Container(
                              ...
                              child: NavigationRail(
                                ...
                                destinations: [
                                  ...
                                  NavigationRailDestination(
                                    icon: Icon(live ? Icons.psychology_alt_outlined : Icons.insights_outlined),
                                    selectedIcon: Icon(live ? Icons.psychology_alt_rounded : Icons.insights_rounded),
                                    label: Text(live
