...
class FarmerLanguage {
  ...
  static const _enFirmware = <String, String>{
    ...
    'STRONG_EP_CHANGE': 'Strong change from learned baseline',
    'EP_CHANGE': 'Changed from learned baseline',
    'KEEP_MONITORING': 'Keep monitoring the plant.',
  ...
  static const _taFirmware = <String, String>{
    ...
    'STRONG_EP_CHANGE': 'கற்ற baseline-இலிருந்து பெரிய மாற்றம்',
    'EP_CHANGE': 'கற்ற baseline-இலிருந்து மாற்றம்',
    'KEEP_MONITORING': 'செடியை தொடர்ந்து கண்காணிக்கவும்.',
