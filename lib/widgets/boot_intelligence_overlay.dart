              ...
              children: [
                ...
                Opacity(
                  ...
                  child: Transform.translate(
                    ...
                    child: _ChannelRail(progress: channels, fusion: fusion),
                  ),
                ),
              ],
            ),
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: const Color(0xFFB9E7D4).withValues(alpha: 0.85),
            boxShadow: [
              BoxShadow(
                color: const Color(0xFF8FE1BD).withValues(alpha: 0.35),
                blurRadius: 10,
                spreadRadius: 1,
              ),
            ],
        ...
        Text(
          '$value%',
          style: TextStyle(
            color: const Color(0xFFB9E7D4).withValues(alpha: 0.55),
            fontSize: 9.5,
            fontWeight: FontWeight.w800,
            letterSpacing: 0.8,
          ),
...
class _ChannelRail extends StatelessWidget {
  ...
  const _ChannelRail({required this.progress, required this.fusion});
        ...
        SizedBox(
          ...
          child: ClipRRect(
            ...
            child: LinearProgressIndicator(
              value: progress,
              minHeight: 2,
              color: const Color(0xFFB9E7D4).withValues(alpha: 0.62),
...
class _ChannelNode extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      height: 42,
      decoration: BoxDecoration(
        color: const Color(0xFFB9E7D4).withValues(alpha: active ? 0.055 : 0.02),
        borderRadius: BorderRadius.circular(13),
        border: Border.all(
          color: const Color(0xFFB9E7D4).withValues(alpha: active ? 0.18 : 0.06),
        ),
      ),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(icon, size: 15, color: const Color(0xFFB9E7D4).withValues(alpha: alpha)),
...
class _BootIntelligencePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final orbitPaint = Paint()
      ...
      ..strokeWidth = 0.9
      ..color = const Color(0xFF9DDEC2).withValues(alpha: 0.045 + fusion * 0.08);
    ...
    final sweepPaint = Paint()
      ...
      ..color = const Color(0xFFB9E7D4).withValues(alpha: 0.12 + scan * 0.15);
    canvas.drawArc(
    ...
    for (var i = 0; i < nodes; i++) {
      ...
      nodePaint.color = const Color(0xFFB9E7D4).withValues(alpha: alpha);
      canvas.drawCircle(p, 1.4 + localPulse * 1.3, nodePaint);

      if (fusion > 0.02) {
        linePaint.color = const Color(0xFF78CFA9).withValues(alpha: 0.018 + fusion * 0.035);
    ...
    final gradient = LinearGradient(
      colors: [
        Colors.transparent,
        const Color(0xFFB9E7D4).withValues(alpha: 0.035 + pulse * 0.025),
        Colors.transparent,
      ],
    ...
    final cornerPaint = Paint()
      ...
      ..strokeWidth = 1
      ..strokeCap = StrokeCap.round
      ..color = const Color(0xFFB9E7D4).withValues(alpha: 0.08 + fusion * 0.05);
    const inset = 17.0;
    const arm = 22.0;
