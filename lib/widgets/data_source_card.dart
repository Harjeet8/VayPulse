  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        final ready = scope.sensors.connectionStatus == SensorConnectionStatus.ready;
        ...
        return Card(child: ListTile(
          ...
          subtitle: Text(live
              ? (ready
                  ? (ta ? 'உங்கள் சாதனத்திலிருந்து புதிய அளவீடுகள்.' : 'Fresh readings from your device.')
                  : (ta ? 'இணைப்புக்காகக் காத்திருக்கிறது. தற்போதைய அளவீடுகள் இல்லை.' : 'Waiting for connection. No current readings.'))
              : (ta ? 'பயிற்சிக்கான தரவு மட்டும். அமைப்புகளில் மாற்றலாம்.' : 'Practice readings only. Change in Settings.')),
