...
class _IlaiAvatarState extends State<IlaiAvatar>
  ...
  @override
  void didUpdateWidget(IlaiAvatar oldWidget) {
      ...
      child: AnimatedBuilder(
          ...
          builder: (_, __) => Transform.rotate(
                ...
                child: CustomPaint(
                    ...
                    painter: _IlaiPainter(motion.value)),
              )));
}
...
class _IlaiPainter extends CustomPainter {
  ...
  void paint(Canvas c, Size size) {
    ...
    c.drawCircle(const Offset(50, 53), 46 + pulse * 2,
        p..color = const Color(0xFFD8EADD));
    final leaf = Path()
      ..moveTo(24, 68)
      ..cubicTo(7, 26, 44, 12, 81, 20)
      ..cubicTo(91, 62, 65, 87, 24, 68)
      ..close();
    c.drawPath(leaf, p..color = const Color(0xFF256F50));
    c.drawPath(
        Path()
          ..moveTo(28, 80)
          ..quadraticBezierTo(37, 67, 63, 43),
        p
          ..color = const Color(0xFF80B98B)
