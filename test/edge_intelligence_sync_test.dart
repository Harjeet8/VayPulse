...
Map<String, dynamic> _basePayload({
  ...
  'sensorIntegrity': <String, dynamic>{
    ...
    'primaryAction': sensorIntegrity == 'FULL'
        ? ''
        : 'Check soil probe connection',
  ...
  'recovery': <String, dynamic>{
    ...
    'farmerResult': recovery == 'RECOVERY_VERIFIED'
        ? 'Plant response recovered.'
        : '',
  },
  ...
  'anomaly': <String, dynamic>{
    ...
    'explanation': anomaly == 'CLEAR' ? '' : 'Soil channel needs verification.',
  },
...
void main() {
    ...
    final payload =
        _basePayload(
          ...
          'temporalReasoning': <String, dynamic>{
            ...
            'explanation': 'Soil moisture fell before the plant electrical response increased.',
          },
  ...
  test('sensor integrity FULL VERIFY and DEGRADED are preserved', () async {
    for (final state in <String>['FULL', 'VERIFY', 'DEGRADED']) {
      final reading = (await _snapshot(_basePayload(sensorIntegrity: state)))
          .reading;
  ...
  test(
    ...
    () async {
      for (final state in <String>[
        ...
        final reading = (await _snapshot(_basePayload(recovery: state)))
            .reading;
